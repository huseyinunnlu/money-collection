          ...
          <div class="card">
            ...
            <div class="card-body table table-responsive p-0">
              ...
              <div class="text-center">
                <a
                  v-if="_series.length < dataCount && !isLoading"
...
<script>
import Item from "@/components/Adminpanel/MoneyOperations/Serie/ListItem.vue";
import Add from "@/components/Adminpanel/MoneyOperations/Serie/Add.vue";
  ...
  methods: {
    get() {
      ...
      this.$appAxios
        ...
        .then((res) => {
          if (this.page == 1) {
            this.$store.state.Opr.series = [];
            this.$store.state.Opr.series = res.data.data;
          } else {
            this.$store.state.Opr.series = this.$store.state.Opr.series.concat(
              res.data.data
            );
          }
