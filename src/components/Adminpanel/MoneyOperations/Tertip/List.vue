...
<script>
import Item from "@/components/Adminpanel/MoneyOperations/Tertip/ListItem.vue";
import Add from "@/components/Adminpanel/MoneyOperations/Tertip/Add.vue";
